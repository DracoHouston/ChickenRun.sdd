...
local custom_cmd_actions = {
	...
	preventoverkill = {cmdType = 2, cmdID = CMD_PREVENT_OVERKILL, name = "Prevent Overkill", states = {'Off', 'When automatically targeting', 'When set to Fire At Will', 'On'}},
	...
	build_field_unit = {cmdType = 1, name = "Build Copied Blueprint"},
