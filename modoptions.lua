...
local options = {
  ...
  {
    key    = 'chickenrunsetslot1',
    name   = 'Weapon/Unit Set Slot One',
    desc   = "Sets the first set slot for chicken run",
    type   = 'list',
    section= 'a_important',
    def    = 'randomstartnodupes',
	items   = {
			{ key='randomstart', name = "Randomize at start", desc = 'A random set is selected at the start for this slot.' },
            { key='randomstartnodupes', name = "Randomize at start, no duplicates", desc = 'A random set is selected at this start for this slot, avoiding already chosen sets.' },
			{ key='randomeverywave', name = "Randomized every wave", desc = 'A random set is given in this slot every wave!' },
			{ key='splattershot', name = "Splattershot", desc = 'SMG' },
			{ key='splatling', name = "Splatling", desc = 'HMG' },
			{ key='blaster', name = "Blaster", desc = 'Airburst' },
			{ key='brella', name = "Brella", desc = 'Scattershot' },
		},
  },
  {
    key    = 'chickenrunsetslot2',
    name   = 'Weapon/Unit Set Slot Two',
    desc   = "Sets the second set slot for chicken run",
    type   = 'list',
    section= 'a_important',
    def    = 'randomstartnodupes',
	items   = {
  ...
  {
    key    = 'chickenrunsetslot3',
    name   = 'Weapon/Unit Set Slot Three',
    desc   = "Sets the third set slot for chicken run",
    type   = 'list',
    section= 'a_important',
    def    = 'randomstartnodupes',
	items   = {
  ...
  {
    key    = 'chickenrunsetslot4',
    name   = 'Weapon/Unit Set Slot Four',
    desc   = "Sets the fourth set slot for chicken run",
    type   = 'list',
    section= 'a_important',
    def    = 'randomstartnodupes',
	items   = {
  ...
  {
    key    = 'chickenrunhazardlevel',
    name   = 'Chicken Run Hazard Level',
    desc   = "Difficulty for Chicken Run, roughly: beginner 0-20, easy 20-80, medium 80-160, hard 160-333",
    type   = 'number',
    section= 'a_important',    
    def=80,
    min=0,
